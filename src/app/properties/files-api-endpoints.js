 ...
 *
 * @param {String} resource the given resource type
 * @param {String} resourceReference the give resource reference
 *
 ...
 *
 * @param {String} fileResource the given file resource
